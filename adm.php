...
<li id="menu-item-110" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-110"><a href="adm_files/html/usuarios.php">Usuarios</a></li>
                    ...
                    <li id="menu-item-110" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-110"><a href="adm_files/html/observacoes.php">Observações</a></li>
