...
<li id="menu-item-109" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-109"><a href="user_files/html/reservas.php">Agendamentos</a></li>
<li id="menu-item-109" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-109"><a href="user_files/html/observacoes.php">Observações</a></li>
<li id="menu-item-101" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-101"><a href="user_files/html/dados_pessoais.php">Dados pessoais</a></li>
...
<div id="page" class="site">
    ...
    <div class="header-content header-content-centered col-md col-xs-12">
        <div class="align-holder center">
            <h1 class="hero-title">Seja bem vindo</h1><p class="header-subtitle">Agendamentos rápidos </p><div data-dynamic-mod-container="" class="header-buttons-wrapper"><a class="button big color1 round" target="_self" href="user_files/html/reservas.php">AGENDAMENTOS DE HOJE</a></div>        </div>
    </div>
</div>
    </div>
