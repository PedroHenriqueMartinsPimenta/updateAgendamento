...
<p>Atualizar dados:</p> 
	<?PHP 
	$sql="SELECT RESERVA.CODIGO AS CODIGOR,EQUIPAMENTO.CODIGO AS CODIGOE,AULA.CODIGO AS CODIGOA, TURMA.CODIGO AS CODIGOT, EQUIPAMENTO.DESCRICAO AS EQUIPAMENTO, DATE_FORMAT(RESERVA.DATA_ULTILIZAR,'%d/%m/%Y') AS DATA, USUARIO.CPF AS CPF, AULA.DESCRICAO AS AULA, TURMA.DESCRICAO AS TURMA FROM RESERVA INNER JOIN USUARIO ON USUARIO.CPF = RESERVA.USUARIO_CPF 
...
function update(){
	...
	dados,
	function(msg){
		location.href="../html/adm/dados/listar";
		});
	}
</script>
</body>
