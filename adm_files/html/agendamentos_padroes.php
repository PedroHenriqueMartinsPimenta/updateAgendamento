...
<div id="page" class="site">
    ...
    <div class="form">
        <form action="../../php/addReservaPadrao.php" method="post" enctype="multipart/form-data">
            <p>Adicionar agendamento padrão</p>
            ...
            <select name="dia_semana">
                <?php
                   ...
                   for ($i=0; $i < sizeof($dia_semana); $i++) { 
                        ?>
                            <option value="<?php echo $i?>"><?php echo $dia_semana[$i]?></option>
                        <?php
                    }
                ?>
            </select>
            <input type="submit" value="Cadastrar" style="margin-top: 10px" class="btn btn-success">
        </form>
    </div>
<div>
...
<table class="table" style="margin-top:20px">
  <thead class="thead-dark">
    <tr>
      <th scope="col" id="icon">Professor</th>
      <th scope="col" id="desc">Turma</th>
      <th scope="col" class="td">Aula</th>
      <th scope="col" class="td">Equipamento</th>
      <th scope="col" class="td">Dia da semana</th>
  ...
  <tbody>
      ...
      ?>
    <tr>
      <th scope="row" id="icon"><?php echo $row['NOME'] ?></th>
      <td id="desc"><?php echo $row['TURMA'] ?></td>
      <td id="desc"><?php echo $row['AULA'] ?></td>
      <td id="desc"><?php echo $row['EQUIPAMENTO'] ?></td>
      <td id="desc"><?php echo $dia_semana[$row['DIA_SEMANA']] ?></td>

      <td class="td"><a href="../../php/delete reserva_padrao.php?codigo=<?php echo $row['CODIGO'] ?>" title="deletar equipamento" class="btn btn-outline-danger">Remover</a></td>
    </tr>
    <?php 
        }
    ?>
